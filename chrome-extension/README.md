...
ثبت Lead به تشخیص شماره در Instagram محدود نیست. پس از ورود، از تب `New Lead`
یا دکمه `Create a lead manually` می‌توان فرم کامل را باز کرد و شماره تلفن،
شناسه مشتری، شناسه Instagram، نام، موضوع، شهر و URL پروفایل را دستی وارد کرد.
ایمیل `{phone}@instalead.com` هنگام تایپ شماره به‌صورت خودکار نمایش داده می‌شود.
